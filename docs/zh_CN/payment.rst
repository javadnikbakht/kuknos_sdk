...
在下面这个示例中，你需要先确保收款账户已经在 Kuknos 网络中激活了。
...
5.5 个由 *GASOCNHNNLYFNMDJYQ3XFMI7BYHIOCFW3GJEOWRPEGK2TDPGTG2E5EDW* 发行的 *GBP*，而付款账户最多会扣除 1000 PMN。以下示例资产经过了
三轮交换：PMN->USD, USD->EUR, EUR->GBP。
