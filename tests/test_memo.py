...
from kuknos_sdk.exceptions import MemoInvalidException
from kuknos_sdk.memo import NoneMemo, Memo, TextMemo, IdMemo, HashMemo, ReturnHashMemo
...
class TestMemo:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (b"Kuknos", "AAAAAQAAAAdTdGVsbGFyAA=="),
        ],
    )
