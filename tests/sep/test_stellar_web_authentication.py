...
from kuknos_sdk import Keypair, Network, Account
from kuknos_sdk.exceptions import ValueError
from kuknos_sdk.operation import ManageData
from kuknos_sdk.sep.ed25519_public_key_signer import Ed25519PublicKeySigner
from kuknos_sdk.sep.exceptions import InvalidSep10ChallengeError
from kuknos_sdk.sep.kuknos_web_authentication import (
...
class TestKuknosWebAuthentication:
    ...
    def test_read_challenge_transaction_fee_bump_transaction_raise(self):
        ...
        inner_tx = (
            ...
            .append_payment_op(destination=destination, amount=amount, asset_code="PMN")
            .add_time_bounds(0, 0)
            .build()
        )
