// Copyright 2015 Kuknos Development Foundation and contributors. Licensed
// under the Apache License, Version 2.0. See the COPYING file at the root
// of this distribution or at http://www.apache.org/licenses/LICENSE-2.0

%#include "xdr/Kuknos-SCP.h"
%#include "xdr/Kuknos-transaction.h"
...
/* KuknosValue is the value used by SCP to reach consensus on a given ledger
 */
struct KuknosValue
{
...
struct LedgerHeader
{
    ...
    KuknosValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from KuknosValue is normalized such that
