...
class Price:
    """Create a new price. Price in Kuknos is represented as a fraction.
    ...
    def from_raw_price(cls, price: Union[str, Decimal]) -> "Price":
        ...
        :raises: :exc:`NoApproximationError <kuknos_sdk.exceptions.NoApproximationError>`:
    ...
    def to_xdr_object(self) -> kuknos_xdr.Price:
        """Returns the xdr object for this price object.

        :return: XDR Price object
        """
        return kuknos_xdr.Price(
            n=kuknos_xdr.Int32(self.n), d=kuknos_xdr.Int32(self.d)
        )

    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Price) -> "Price":
