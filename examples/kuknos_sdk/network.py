...
class Network:
    """The :class:`Network` object, which represents a Kuknos network.

    This class represents such a kuknos network such as the Public network and the Test network.

    :param str network_passphrase: The passphrase for the network.
        (ex. 'Public Global Kuknos Network ; September 2015')

    """

    PUBLIC_NETWORK_PASSPHRASE: str = "Public Global Kuknos Network ; September 2015"
