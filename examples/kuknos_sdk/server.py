...
class Server:
    """Server handles the network connection to a `Horizon <https://www.kuknos.org/developers/horizon/reference/>`_
    instance and exposes an interface for requests to that instance.

    Here we need to talk about the **client** parameter, if you do not specify the client, we will use
    the :class:`kuknos_sdk.client.requests_client.RequestsClient` instance by default, it is a synchronous HTTPClient,
    you can also specify an asynchronous HTTP Client,
    for example: :class:`kuknos_sdk.client.aiohttp_client.AiohttpClient`. If you use a synchronous client,
    ...
    :param horizon_url: Horizon Server URL (ex. `https://horizon-testnet.kuknos.org`)
    :param client: Http Client used to send the request
    :raises: :exc:`TypeError <kuknos_sdk.exceptions.TypeError>`: if the ``client`` does not meet the standard.
    """

    def __init__(
        self,
        horizon_url: str = "https://horizon-testnet.kuknos.org/",
    ...
    def submit_transaction(
        ...
        :param transaction_envelope: :class:`kuknos_sdk.transaction_envelope.TransactionEnvelope` object
            or base64 encoded xdr
        :return: the response from horizon
        :raises:
            :exc:`ConnectionError <kuknos_sdk.exceptions.ConnectionError>`
            :exc:`NotFoundError <kuknos_sdk.exceptions.NotFoundError>`
            :exc:`BadRequestError <kuknos_sdk.exceptions.BadRequestError>`
            :exc:`BadResponseError <kuknos_sdk.exceptions.BadResponseError>`
            :exc:`UnknownRequestError <kuknos_sdk.exceptions.UnknownRequestError>`
            :exc:`AccountRequiresMemoError <kuknos_sdk.sep.exceptions.AccountRequiresMemoError>`
        """
        if self.__async:
    ...
    def root(self) -> RootCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.RootCallBuilder` object configured
    ...
    def accounts(self) -> AccountsCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.AccountsCallBuilder` object configured
            by a current Horizon server configuration.
        """
    ...
    def assets(self) -> AssetsCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.AssetsCallBuilder` object configured by
    ...
    def claimable_balances(self) -> ClaimableBalancesCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.ClaimableBalancesCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def data(self, account_id: str, data_name: str):
        """
        :return: New :class:`kuknos_sdk.call_builder.DataCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def effects(self) -> EffectsCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.EffectsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def fee_stats(self) -> FeeStatsCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.FeeStatsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def ledgers(self) -> LedgersCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.LedgersCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def offers(self) -> OffersCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.OffersCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def operations(self) -> OperationsCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.OperationsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def orderbook(self, selling: Asset, buying: Asset) -> OrderbookCallBuilder:
        ...
        :return: New :class:`kuknos_sdk.call_builder.OrderbookCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def strict_receive_paths(
        ...
        :return: New :class:`kuknos_sdk.call_builder.StrictReceivePathsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def payments(self) -> PaymentsCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.PaymentsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def trade_aggregations(
        ...
        :return: New :class:`kuknos_sdk.call_builder.TradeAggregationsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def trades(self) -> TradesCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.TradesCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def transactions(self) -> TransactionsCallBuilder:
        """
        :return: New :class:`kuknos_sdk.call_builder.TransactionsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def load_account(
        ...
        and returns an :class:`kuknos_sdk.account.Account` object.

        :param account_id: The account to load.
        :return: an :class:`kuknos_sdk.account.Account` object.
        :raises:
            :exc:`ConnectionError <kuknos_sdk.exceptions.ConnectionError>`
            :exc:`NotFoundError <kuknos_sdk.exceptions.NotFoundError>`
            :exc:`BadRequestError <kuknos_sdk.exceptions.BadRequestError>`
