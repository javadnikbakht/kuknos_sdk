...
class Account:
    ...
    account on the Kuknos network and its sequence number.

    Account tracks the sequence number as it is used
    by :class:`TransactionBuilder <kuknos_sdk.transaction_builder.TransactionBuilder>`
    ...
    .. _Accounts:
        https://kuknos.org/developers/learn/concepts/accounts.html
    """
