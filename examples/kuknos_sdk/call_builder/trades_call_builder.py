...
class TradesCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.trades`.

    See `Trades <https://www.kuknos.org/developers/horizon/reference/endpoints/trades.html)>`_
    ...
    def for_offer(self, offer_id: Union[int, str]) -> "TradesCallBuilder":
        ...
        See `Trades for Offer <https://www.kuknos.org/developers/horizon/reference/endpoints/trades-for-offer.html>`_
    ...
    def for_account(self, account_id: str) -> "TradesCallBuilder":
        ...
        See `Trades for Account <https://www.kuknos.org/developers/horizon/reference/endpoints/trades-for-account.html>`_
