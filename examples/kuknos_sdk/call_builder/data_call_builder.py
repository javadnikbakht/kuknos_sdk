...
class DataCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.data`.

    See `Data for Account <https://www.kuknos.org/developers/horizon/reference/endpoints/data-for-account.html>`_
