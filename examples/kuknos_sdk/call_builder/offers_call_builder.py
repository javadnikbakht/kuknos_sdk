...
class OffersCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.offers`.

    See `Offer Details <https://www.kuknos.org/developers/horizon/reference/endpoints/offer-details.html>`_
    See `Offers <https://www.kuknos.org/developers/horizon/reference/endpoints/offers.html>`_
    ...
    def for_seller(self, seller: str):
        ...
        People on the Kuknos network can make offers to buy or sell assets.
    ...
    def for_sponsor(self, sponsor: str) -> "OffersCallBuilder":
        ...
        See `Offer Details <https://developers.kuknos.org/api/resources/offers/>`_
