...
class ClaimableBalancesCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.claimable_balance`.
    ...
    def claimable_balance(
        ...
        See `Claimable Balances <https://developers.kuknos.org/api/resources/claimablebalances/list/>`_
    ...
    def for_asset(self, asset: Asset) -> "ClaimableBalancesCallBuilder":
        ...
        See `Account Details <https://www.kuknos.org/developers/horizon/reference/endpoints/accounts-single.html>`_
