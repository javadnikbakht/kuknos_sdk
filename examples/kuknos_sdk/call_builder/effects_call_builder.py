...
class EffectsCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.effects`.

    See `All Effects <https://www.kuknos.org/developers/horizon/reference/endpoints/effects-all.html>`_
    ...
    def for_account(self, account_id: str) -> "EffectsCallBuilder":
        ...
        See `Effects for Account <https://www.kuknos.org/developers/horizon/reference/endpoints/effects-all.html>`_
    ...
    def for_ledger(self, sequence: Union[int, str]) -> "EffectsCallBuilder":
        ...
        See `Effects for Ledger <https://www.kuknos.org/developers/horizon/reference/endpoints/effects-for-account.html>`_
    ...
    def for_transaction(self, transaction_hash: str) -> "EffectsCallBuilder":
        ...
        See `Effects for Transaction <https://www.kuknos.org/developers/horizon/reference/endpoints/effects-for-transaction.html>`_
    ...
    def for_operation(self, operation_id: Union[int, str]) -> "EffectsCallBuilder":
        ...
        See `Effects for Operation <https://www.kuknos.org/developers/horizon/reference/endpoints/effects-for-operation.html>`_
