...
class TransactionsCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.transactions`.

    See `All Transactions <https://www.kuknos.org/developers/horizon/reference/endpoints/transactions-all.html>`_
    ...
    def transaction(self, transaction_hash: str) -> "TransactionsCallBuilder":
        ...
        See `Transaction Details <https://www.kuknos.org/developers/horizon/reference/endpoints/transactions-single.html>`_
    ...
    def for_account(self, account_id: str) -> "TransactionsCallBuilder":
        ...
        See `Transactions for Account <https://www.kuknos.org/developers/horizon/reference/endpoints/transactions-for-account.html>`_
    ...
    def for_ledger(self, sequence: Union[str, int]) -> "TransactionsCallBuilder":
        ...
        See `Transactions for Ledger <https://www.kuknos.org/developers/horizon/reference/endpoints/transactions-for-ledger.html>`_
