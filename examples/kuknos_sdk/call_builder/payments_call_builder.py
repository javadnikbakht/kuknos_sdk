...
class PaymentsCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.payments`.

    See `All Payments <https://www.kuknos.org/developers/horizon/reference/endpoints/payments-all.html>`_
    ...
    def for_account(self, account_id: str) -> "PaymentsCallBuilder":
        ...
        See `Payments for Account <https://www.kuknos.org/developers/horizon/reference/endpoints/payments-for-account.html>`_
    ...
    def for_ledger(self, sequence: Union[int, str]) -> "PaymentsCallBuilder":
        ...
        See `Payments for Ledger <https://www.kuknos.org/developers/horizon/reference/endpoints/payments-for-ledger.html>`_
    ...
    def for_transaction(self, transaction_hash: str) -> "PaymentsCallBuilder":
        ...
        See `Payments for Transaction <https://www.kuknos.org/developers/horizon/reference/endpoints/payments-for-transaction.html>`_
