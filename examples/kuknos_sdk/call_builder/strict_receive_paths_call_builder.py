...
class StrictReceivePathsCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.strict_receive_paths`.

    The Kuknos Network allows payments to be made across assets through path payments. A path payment specifies a
    ...
    See `Find Payment Paths <https://www.kuknos.org/developers/horizon/reference/endpoints/path-finding.html>`_
