...
def parse_transaction_envelope_from_xdr(
    ...
    """When you are not sure whether your XDR belongs to
        ...
        or :py:class:`FeeBumpTransactionEnvelope <kuknos_sdk.fee_bump_transaction_envelope.FeeBumpTransactionEnvelope>`,
    ...
    :raises: :exc:`ValueError <kuknos_sdk.exceptions.ValueError>` - XDR is neither :py:class:`TransactionEnvelope <kuknos_sdk.transaction_envelope.TransactionEnvelope>`
        nor :py:class:`FeeBumpTransactionEnvelope <kuknos_sdk.fee_bump_transaction_envelope.FeeBumpTransactionEnvelope>`
    """
