...
class FeeBumpTransactionEnvelope(BaseTransactionEnvelope["FeeBumpTransactionEnvelope"]):
    ...
    def signature_base(self) -> bytes:
        ...
        packer = Packer()
        kuknos_xdr.EnvelopeType.ENVELOPE_TYPE_TX_FEE_BUMP.pack(packer)
    ...
    def to_xdr_object(self) -> kuknos_xdr.TransactionEnvelope:
        ...
        te_type = kuknos_xdr.EnvelopeType.ENVELOPE_TYPE_TX_FEE_BUMP
        tx_envelope = kuknos_xdr.FeeBumpTransactionEnvelope(tx, self.signatures)
        return kuknos_xdr.TransactionEnvelope(type=te_type, fee_bump=tx_envelope)
