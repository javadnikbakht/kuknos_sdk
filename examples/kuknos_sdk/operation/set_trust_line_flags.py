...
class TrustLineFlags(IntFlag):
    ...
    please refer to the `CAP-0035 <https://github.com/kuknos/kuknos-protocol/blob/master/core/cap-0035.md>`_.
...
class SetTrustLineFlags(Operation):
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = (
        kuknos_xdr.OperationType.SET_TRUST_LINE_FLAGS
    )
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        ...
        set_trust_line_flags_op = kuknos_xdr.SetTrustLineFlagsOp(
            trustor,
            self.asset.to_xdr_object(),
            kuknos_xdr.Uint32(clear_flags),
            kuknos_xdr.Uint32(set_flags),
        )
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Operation) -> "SetTrustLineFlags":
