...
class ChangeTrust(Operation):
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.CHANGE_TRUST
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        ...
        limit = kuknos_xdr.Int64(Operation.to_xdr_amount(self.limit))
        change_trust_op = kuknos_xdr.ChangeTrustOp(line, limit)
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Operation) -> "ChangeTrust":
