...
class CreatePassiveSellOffer(Operation):
    ...
    CreatePassiveSellOffer operation on Kuknos's network.
    ...
    example, if an offer exists to buy 5 BTC for 30 PMN, and you make a passive
    sell offer to buy 30 PMN for 5 BTC, your passive sell offer does not take the first
    offer.
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.CREATE_PASSIVE_SELL_OFFER
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        ...
        amount = kuknos_xdr.Int64(Operation.to_xdr_amount(self.amount))
        create_passive_sell_offer_op = kuknos_xdr.CreatePassiveSellOfferOp(
