...
class ManageSellOffer(Operation):
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.MANAGE_SELL_OFFER
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        ...
        manage_sell_offer_op = kuknos_xdr.ManageSellOfferOp(
            selling, buying, amount, price, kuknos_xdr.Int64(self.offer_id)
        )
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Operation) -> "ManageSellOffer":
