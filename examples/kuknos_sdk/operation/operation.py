...
class Operation(metaclass=ABCMeta):
    ...
    An operation is an individual command that mutates Kuknos's ledger. It is
    ...
    For more on operations, see `Kuknos's documentation on operations
    <https://www.kuknos.org/developers/guides/concepts/operations.html>`_ as
    well as `Kuknos's List of Operations
    <https://www.kuknos.org/developers/guides/concepts/list-of-operations.html>`_,
    ...
    @property
    @abstractmethod
    def _XDR_OPERATION_TYPE(self) -> kuknos_xdr.OperationType:
    ...
    def to_xdr_amount(value: Union[str, Decimal]) -> int:
        ...
        See `Kuknos's documentation on Asset Precision
        <https://www.kuknos.org/developers/guides/concepts/assets.html#amount-precision-and-representation>`_
    ...
    def to_xdr_object(self) -> kuknos_xdr.Operation:
        ...
        return kuknos_xdr.Operation(source_account, self._to_operation_body())

    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Operation) -> "Operation":
    ...
    @staticmethod
    def get_source_from_xdr_obj(xdr_object: kuknos_xdr.Operation,) -> Optional[str]:
    ...
    def get_source_muxed_from_xdr_obj(
        xdr_object: kuknos_xdr.Operation,
    ) -> Optional[kuknos_xdr.MuxedAccount]:
        """Get the source account from account the operation xdr object.
