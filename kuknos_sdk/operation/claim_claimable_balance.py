...
class ClaimClaimableBalance(Operation):
    ...
    <https://developers.kuknos.org/docs/start/list-of-operations/#claim-claimable-balance>_`.
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.CLAIM_CLAIMABLE_BALANCE
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        ...
        claim_claimable_balance_op = kuknos_xdr.ClaimClaimableBalanceOp(
