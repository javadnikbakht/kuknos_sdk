...
class Clawback(Operation):
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.CLAWBACK
    ...
    def __init__(
        ...
        self._from__muxed: Optional[kuknos_xdr.MuxedAccount] = None
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        ...
        clawback_op = kuknos_xdr.ClawbackOp(asset, from_, kuknos_xdr.Int64(amount))
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Operation) -> "Clawback":
