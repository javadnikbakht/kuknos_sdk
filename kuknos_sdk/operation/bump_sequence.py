...
class BumpSequence(Operation):
    ...
    BumpSequence operation on Kuknos's network.
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.BUMP_SEQUENCE
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        sequence = kuknos_xdr.SequenceNumber(kuknos_xdr.Int64(self.bump_to))
        bump_sequence_op = kuknos_xdr.BumpSequenceOp(sequence)
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Operation) -> "BumpSequence":
