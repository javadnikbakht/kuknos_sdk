...
class AccountMerge(Operation):
    ...
    AccountMerge operation on Kuknos's network.

    Transfers the native balance (the amount of PMN an account holds) to
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.ACCOUNT_MERGE
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Operation) -> "AccountMerge":
