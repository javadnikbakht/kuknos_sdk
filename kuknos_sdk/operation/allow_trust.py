...
class TrustLineEntryFlag(IntFlag):
    ...
    please refer to the `CAP-0018 <https://github.com/kuknos/kuknos-protocol/blob/master/core/cap-0018.md>`_.
...
class AllowTrust(Operation):
    ...
    <https://www.kuknos.org/developers/guides/concepts/assets.html>`_.
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.ALLOW_TRUST
    ...
    def __init__(
        ...
        warnings.warn(
            ...
            "use `kuknos_sdk.operation.set_trust_line_flags.SetTrustLineFlags` instead.",
            DeprecationWarning,
        )
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        ...
        authorize = kuknos_xdr.Uint32(self.authorize.value)
        if len(asset_code) == 4:
            asset_type = kuknos_xdr.AssetType.ASSET_TYPE_CREDIT_ALPHANUM4
            asset_code4 = kuknos_xdr.AssetCode4(asset_code)
            asset = kuknos_xdr.AssetCode(
                type=asset_type, asset_code4=asset_code4
            )
        else:
            asset_type = kuknos_xdr.AssetType.ASSET_TYPE_CREDIT_ALPHANUM12
            asset_code12 = kuknos_xdr.AssetCode12(asset_code)
            asset = kuknos_xdr.AssetCode(
                type=asset_type, asset_code12=asset_code12
            )
        allow_trust_op = kuknos_xdr.AllowTrustOp(trustor, asset, authorize)
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Operation) -> "AllowTrust":
        ...
        if asset_type == kuknos_xdr.AssetType.ASSET_TYPE_CREDIT_ALPHANUM4:
        ...
        elif asset_type == kuknos_xdr.AssetType.ASSET_TYPE_CREDIT_ALPHANUM12:
