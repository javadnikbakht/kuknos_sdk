...
class ManageBuyOffer(Operation):
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.MANAGE_BUY_OFFER
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        ...
        manage_buy_offer_op = kuknos_xdr.ManageBuyOfferOp(
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Operation) -> "ManageBuyOffer":
