...
class Payment(Operation):
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.PAYMENT
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        ...
        payment_op = kuknos_xdr.PaymentOp(destination, asset, amount)
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Operation) -> "Payment":
