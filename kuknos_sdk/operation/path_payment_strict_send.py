...
class PathPaymentStrictSend(Operation):
    ...
    _XDR_OPERATION_TYPE: kuknos_xdr.OperationType = kuknos_xdr.OperationType.PATH_PAYMENT_STRICT_SEND
    ...
    def _to_operation_body(self) -> kuknos_xdr.OperationBody:
        ...
        path_payment_strict_send_op = kuknos_xdr.PathPaymentStrictSendOp(
            send_asset,
            kuknos_xdr.Int64(Operation.to_xdr_amount(self.send_amount)),
            destination,
            dest_asset,
            kuknos_xdr.Int64(Operation.to_xdr_amount(self.dest_min)),
            path,
        )
