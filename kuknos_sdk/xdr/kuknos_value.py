...
class KuknosValue:
    ...
    @classmethod
    def unpack(cls, unpacker: Unpacker) -> "KuknosValue":
        ...
        ext = KuknosValueExt.unpack(unpacker)
        return cls(
    ...
    @classmethod
    def from_xdr_bytes(cls, xdr: bytes) -> "KuknosValue":
    ...
    @classmethod
    def from_xdr(cls, xdr: str) -> "KuknosValue":
