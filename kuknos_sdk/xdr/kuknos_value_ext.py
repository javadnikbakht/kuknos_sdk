...
__all__ = ["KuknosValueExt"]


class KuknosValueExt:
    """
    XDR Source Code
    ----------------------------------------------------------------
    union switch (KuknosValueType v)
        {
    ...
    def pack(self, packer: Packer) -> None:
        self.v.pack(packer)
        if self.v == KuknosValueType.STELLAR_VALUE_BASIC:
            return
        if self.v == KuknosValueType.STELLAR_VALUE_SIGNED:
    ...
    @classmethod
    def unpack(cls, unpacker: Unpacker) -> "KuknosValueExt":
        v = KuknosValueType.unpack(unpacker)
        if v == KuknosValueType.STELLAR_VALUE_BASIC:
            return cls(v)
        if v == KuknosValueType.STELLAR_VALUE_SIGNED:
    ...
    @classmethod
    def from_xdr_bytes(cls, xdr: bytes) -> "KuknosValueExt":
    ...
    @classmethod
    def from_xdr(cls, xdr: str) -> "KuknosValueExt":
    ...
    def __str__(self):
        ...
        return f"<KuknosValueExt {[', '.join(out)]}>"
