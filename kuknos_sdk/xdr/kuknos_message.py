...
class KuknosMessage:
    ...
    XDR Source Code
    ----------------------------------------------------------------
    union KuknosMessage switch (MessageType type)
    {
    case ERROR_MSG:
        Error error;
    case HELLO:
    ...
    @classmethod
    def unpack(cls, unpacker: Unpacker) -> "KuknosMessage":
    ...
    @classmethod
    def from_xdr_bytes(cls, xdr: bytes) -> "KuknosMessage":
    ...
    @classmethod
    def from_xdr(cls, xdr: str) -> "KuknosMessage":
    ...
    def __str__(self):
        ...
        return f"<KuknosMessage {[', '.join(out)]}>"
