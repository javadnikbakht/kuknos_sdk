...
USER_AGENT = f"py-kuknos-sdk/{__version__}/RequestsClient"
IDENTIFICATION_HEADERS = {
    "X-Client-Name": "py-kuknos-sdk",
...
class RequestsClient(BaseSyncClient):
    ...
    def get(self, url: str, params: Dict[str, str] = None) -> Response:
        ...
        :raise: :exc:`ConnectionError <kuknos_sdk.exceptions.ConnectionError>`
        """
        try:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if SSEClient is None:
            raise ImportError(
                "SSE not supported, missing `kuknos-base-sseclient` module"
            )  # pragma: no cover
