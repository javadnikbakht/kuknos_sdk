...
class Memo(object, metaclass=abc.ABCMeta):
    ...
    * :class:`RetHashMemo` -  A 32 byte hash intended to be interpreted as the hash of the transaction the sender is refunding.
    ...
    See `Kuknos's documentation on Transactions
    <https://www.kuknos.org/developers/guides/concepts/transactions.html#memo>`__
    ...
    @abc.abstractmethod
    def to_xdr_object(self) -> kuknos_xdr.Memo:
        """Creates an XDR Memo object that represents this :class:`Memo`."""

    @staticmethod
    def from_xdr_object(xdr_object: kuknos_xdr.Memo) -> "Memo":
        """Returns an Memo object from XDR memo object."""

        xdr_types = {
            kuknos_xdr.MemoType.MEMO_TEXT: TextMemo,
            kuknos_xdr.MemoType.MEMO_ID: IdMemo,
            kuknos_xdr.MemoType.MEMO_HASH: HashMemo,
            kuknos_xdr.MemoType.MEMO_RETURN: ReturnHashMemo,
            kuknos_xdr.MemoType.MEMO_NONE: NoneMemo,
        }
...
class NoneMemo(Memo):
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Memo) -> "NoneMemo":
    ...
    def to_xdr_object(self) -> kuknos_xdr.Memo:
        ...
        return kuknos_xdr.Memo(type=kuknos_xdr.MemoType.MEMO_NONE)
...
class TextMemo(Memo):
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Memo) -> "TextMemo":
    ...
    def to_xdr_object(self) -> kuknos_xdr.Memo:
        ...
        return kuknos_xdr.Memo(
            type=kuknos_xdr.MemoType.MEMO_TEXT, text=self.memo_text
        )
...
class IdMemo(Memo):
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Memo) -> "IdMemo":
    ...
    def to_xdr_object(self) -> kuknos_xdr.Memo:
        ...
        return kuknos_xdr.Memo(
            type=kuknos_xdr.MemoType.MEMO_ID, id=kuknos_xdr.Uint64(self.memo_id)
        )
...
class HashMemo(Memo):
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Memo) -> "HashMemo":
    ...
    def to_xdr_object(self) -> kuknos_xdr.Memo:
        ...
        return kuknos_xdr.Memo(
            type=kuknos_xdr.MemoType.MEMO_HASH, hash=kuknos_xdr.Hash(self.memo_hash)
        )
...
class ReturnHashMemo(Memo):
    ...
    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Memo) -> "ReturnHashMemo":
    ...
    def to_xdr_object(self) -> kuknos_xdr.Memo:
        ...
        return kuknos_xdr.Memo(
            type=kuknos_xdr.MemoType.MEMO_RETURN,
            ret_hash=kuknos_xdr.Hash(self.memo_return),
        )
