...
class OperationsCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.operations`.

    See `All Operations <https://www.kuknos.org/developers/horizon/reference/endpoints/operations-all.html>`_
    ...
    def operation(self, operation_id: Union[int, str]) -> "OperationsCallBuilder":
        ...
        See `Operation Details <https://www.kuknos.org/developers/horizon/reference/endpoints/operations-single.html>`_
    ...
    def for_account(self, account_id: str) -> "OperationsCallBuilder":
        ...
        See `Operations for Account <https://www.kuknos.org/developers/horizon/reference/endpoints/operations-for-account.html>`_
    ...
    def for_ledger(self, sequence: Union[int, str]) -> "OperationsCallBuilder":
        ...
        See `Operations for Ledger <https://www.kuknos.org/developers/horizon/reference/endpoints/operations-for-ledger.html>`_
    ...
    def for_transaction(self, transaction_hash: str) -> "OperationsCallBuilder":
        ...
        See `Operations for Transaction <https://www.kuknos.org/developers/horizon/reference/endpoints/operations-for-transaction.html>`_
