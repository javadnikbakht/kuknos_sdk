...
class OrderbookCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.orderbook`.

    See `Orderbook Details <https://www.kuknos.org/developers/horizon/reference/endpoints/orderbook-details.html>`_
