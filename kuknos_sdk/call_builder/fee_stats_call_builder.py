...
class FeeStatsCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.fee_stats`.

    See `Fee Stats <https://www.kuknos.org/developers/horizon/reference/endpoints/fee-stats.html>`_
