...
class LedgersCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.ledgers`.

    See `All Ledgers <https://www.kuknos.org/developers/horizon/reference/endpoints/ledgers-all.html>`_
    ...
    def ledger(self, sequence: Union[int, str]) -> "LedgersCallBuilder":
        ...
        See `Ledger Details <https://www.kuknos.org/developers/horizon/reference/endpoints/ledgers-single.html>`_
