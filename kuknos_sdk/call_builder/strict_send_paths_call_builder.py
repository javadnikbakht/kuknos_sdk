...
class StrictSendPathsCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.strict_send_paths`.

    The Kuknos Network allows payments to be made across assets through path
