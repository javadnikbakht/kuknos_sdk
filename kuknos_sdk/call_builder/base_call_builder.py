...
class BaseCallBuilder:
    ...
    This is an **abstract** class. Do not create this object directly, use :class:`kuknos_sdk.server.Server` class.
    ...
    def call(self) -> Union[Dict[str, Any], Coroutine[Any, Any, Dict[str, Any]]]:
        ...
        :raises:
            | :exc:`ConnectionError <kuknos_sdk.exceptions.ConnectionError>`: if you have not successfully
                connected to the server.
            | :exc:`NotFoundError <kuknos_sdk.exceptions.NotFoundError>`: if status_code == 404
            | :exc:`BadRequestError <kuknos_sdk.exceptions.BadRequestError>`: if 400 <= status_code < 500
                and status_code != 404
            | :exc:`BadResponseError <kuknos_sdk.exceptions.BadResponseError>`: if 500 <= status_code < 600
            | :exc:`UnknownRequestError <kuknos_sdk.exceptions.UnknownRequestError>`: if an unknown error occurs,
    ...
    def stream(
        ...
        See `Horizon Response Format <https://www.kuknos.org/developers/horizon/reference/responses.html>`_
    ...
    def cursor(self, cursor: Union) -> "BaseCallBuilder":
        ...
        See `Paging <https://www.kuknos.org/developers/horizon/reference/paging.html>`_
