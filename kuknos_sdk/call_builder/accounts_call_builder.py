...
class AccountsCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.accounts`.
    ...
    def for_sponsor(self, sponsor: str) -> "AccountsCallBuilder":
        ...
        See `Account Details <https://developers.kuknos.org/api/resources/accounts/single/>`_
