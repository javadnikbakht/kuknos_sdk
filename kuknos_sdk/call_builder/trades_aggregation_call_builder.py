...
class TradeAggregationsCallBuilder(BaseCallBuilder):
    ...
    Do not create this object directly, use :func:`kuknos_sdk.server.Server.trade_aggregations`.

    Trade Aggregations facilitate efficient gathering of historical trade data.

    See `Trade Aggregations <https://www.kuknos.org/developers/horizon/reference/endpoints/trade_aggregations.html>`_
