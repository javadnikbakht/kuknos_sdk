...
class Signer:
    """The :class:`Signer` object, which represents an account signer on Kuknos's network.
    ...
    def to_xdr_object(self) -> kuknos_xdr.Signer:
        """Returns the xdr object for this Signer object.

        :return: XDR Signer object
        """
        return kuknos_xdr.Signer(
            self.signer_key.to_xdr_object(), kuknos_xdr.Uint32(self.weight)
        )

    @classmethod
    def from_xdr_object(cls, xdr_object: kuknos_xdr.Signer) -> "Signer":
