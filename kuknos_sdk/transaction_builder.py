...
class TransactionBuilder:
    ...
    <kuknos_sdk.transaction_envelope.TransactionEnvelope>` using the given
    :class:`Account <kuknos_sdk.account.Account>` as the transaction's "source account". The transaction will use
    ...
    Be careful about **unsubmitted transactions**! When you build a transaction, kuknos-sdk automatically
    ...
    transaction, make sure to update the source account's sequence number with :meth:`kuknos_sdk.Server.load_account`
    ...
    :param v1: When this value is set to True, V1 transactions will be generated,
        ...
        See `CAP-0015 <https://github.com/kuknos/kuknos-protocol/blob/master/core/cap-0015.md>`_ for more information.
    """
    ...
    def build_fee_bump_transaction(
        ...
        """Create a
        :py:class:`FeeBumpTransactionEnvelope <kuknos_sdk.fee_bump_transaction_envelope.FeeBumpTransactionEnvelope>`
        object.
        ...
        :param network_passphrase: The network to connect to for verifying and retrieving additional attributes from.
        :return: a :class:`TransactionBuilder <kuknos_sdk.transaction_envelope.TransactionBuilder>` via the XDR object.
        """
    ...
    def from_xdr(
        ...
        <kuknos_sdk.transaction_envelope.TransactionBuilder>` or
        :py:class:`FeeBumpTransactionEnvelope <kuknos_sdk.fee_bump_transaction_envelope.FeeBumpTransactionEnvelope>`
        via an XDR object.

        In addition, if xdr is not of
        :py:class:`TransactionEnvelope <kuknos_sdk.transaction_envelope.TransactionEnvelope>`,
        ...
        :param network_passphrase: The network to connect to for verifying and retrieving additional attributes from.
        :return: a :class:`TransactionBuilder <kuknos_sdk.transaction_envelope.TransactionBuilder>` or
            :py:class:`FeeBumpTransactionEnvelope <kuknos_sdk.fee_bump_transaction_envelope.FeeBumpTransactionEnvelope>`
            via the XDR object.
        """
        xdr_object = kuknos_xdr.TransactionEnvelope.from_xdr(xdr)
        te_type = xdr_object.type
        if te_type == kuknos_xdr.EnvelopeType.ENVELOPE_TYPE_TX_FEE_BUMP:
    ...
    def set_timeout(self, timeout: int) -> "TransactionBuilder":
        ...
        :return: This builder instance.
        :raises:
            :exc:`ValueError <kuknos_sdk.exceptions.ValueError>`: if time_bound is already set.
        """
        if self.time_bounds:
            raise ValueError(
    ...
    def add_text_memo(self, memo_text: Union[str, bytes]) -> "TransactionBuilder":
        ...
        <kuknos_sdk.memo.TextMemo>`.

        :param memo_text: The text for the memo to add.
        :return: This builder instance.
        :raises: :exc:`MemoInvalidException <kuknos_sdk.exceptions.MemoInvalidException>`:
    ...
    def add_id_memo(self, memo_id: int) -> "TransactionBuilder":
        ...
        <kuknos_sdk.memo.IdMemo>`.

        :param memo_id: A 64 bit unsigned integer to set as the memo.
        :return: This builder instance.
        :raises:
            :exc:`MemoInvalidException <kuknos_sdk.exceptions.MemoInvalidException>`:
    ...
    def add_return_hash_memo(
        ...
        <kuknos_sdk.memo.ReturnHashMemo>`.
    ...
    def append_create_account_op(
        ...
        <kuknos_sdk.operation.CreateAccount>` operation to the list of
        operations.

        :param destination: Account address that is created and funded.
        :param starting_balance: Amount of PMN to send to the newly created
            account. This PMN comes from the source account.
    ...
    def append_change_trust_op(
        ...
        """Append a :class:`ChangeTrust <kuknos_sdk.operation.ChangeTrust>`
    ...
    def append_payment_op(
        ...
        """Append a :class:`Payment <kuknos_sdk.operation.Payment>` operation
    ...
    def append_path_payment_strict_receive_op(
        ...
        """Append a :class:`PathPaymentStrictReceive <kuknos_sdk.operation.PathPaymentStrictReceive>`
        operation to the list of operations.
    ...
    def append_path_payment_strict_send_op(
        ...
        """Append a :class:`PathPaymentStrictSend <kuknos_sdk.operation.PathPaymentStrictSend>`
        operation to the list of operations.
    ...
    def append_allow_trust_op(
        ...
        """Append an :class:`AllowTrust <kuknos_sdk.operation.AllowTrust>`
        operation to the list of operations.
        ...
        :param authorize: `True` to authorize the line, `False` to deauthorize，if you need further control,
            you can also use :class:`kuknos_sdk.operation.allow_trust.TrustLineEntryFlag`.
        ...
        warnings.warn(
            ...
            "use `kuknos_sdk.transaction_builder.TransactionBuilder.append_set_trust_line_flags_op` instead.",
            DeprecationWarning,
        )
    ...
    def append_set_options_op(
        ...
        """Append a :class:`SetOptions <kuknos_sdk.operation.SetOptions>`
        operation to the list of operations.
        ...
        :param clear_flags: Indicates which flags to clear. For details about the flags,
            please refer to the `accounts doc <https://www.kuknos.org/developers/guides/concepts/accounts.html>`__.
            ...
            :class:`kuknos_sdk.operation.set_options.AuthorizationFlag`
        ...
        :param low_threshold: A number from 0-255 (inclusive) representing the threshold this account sets on all
            operations it performs that have `a low threshold <https://www.kuknos.org/developers/guides/concepts/multi-sig.html>`_.
        :param med_threshold: A number from 0-255 (inclusive) representing the threshold this account sets on all
            operations it performs that have `a medium threshold <https://www.kuknos.org/developers/guides/concepts/multi-sig.html>`_.
        :param high_threshold: A number from 0-255 (inclusive) representing the threshold this account sets on all
            operations it performs that have `a high threshold <https://www.kuknos.org/developers/guides/concepts/multi-sig.html>`_.
        :param home_domain: sets the home domain used for
            reverse `federation <https://www.kuknos.org/developers/guides/concepts/federation.html>`_ lookup.
    ...
    def append_ed25519_public_key_signer(
        ...
        <kuknos_sdk.operation.SetOptions` operation. This is a helper
    ...
    def append_pre_auth_tx_signer(
        ...
        :param pre_auth_tx_hash: The address of the new preAuthTx signer - obtained by calling ``hash`` on
            the :class:`TransactionEnvelope <kuknos_sdk.transaction_envelope.TransactionEnvelope>`,
            a 32 byte hash or hex encoded string.
        :param weight: The weight of the new signer.
        :param source: The source account that is adding a signer to its
            list of signers.
    ...
    def append_manage_buy_offer_op(
        ...
        """Append a :class:`ManageBuyOffer <kuknos_sdk.operation.ManageBuyOffer>`
        operation to the list of operations.
    ...
    def append_manage_sell_offer_op(
        ...
        """Append a :class:`ManageSellOffer <kuknos_sdk.operation.ManageSellOffer>`
        operation to the list of operations.
    ...
    def append_create_passive_sell_offer_op(
        ...
        <kuknos_sdk.operation.CreatePassiveSellOffer>` operation to the list of
        operations.
        ...
        :param source: The source address that is creating a passive offer
            on Kuknos's distributed exchange.
        :return: This builder instance.
    ...
    def append_account_merge_op(
        ...
        <kuknos_sdk.operation.AccountMerge>` operation to the list of
        operations.
    ...
    def append_inflation_op(self, source: str = None) -> "TransactionBuilder":
        ...
        <kuknos_sdk.operation.Inflation>` operation to the list of
        operations.
    ...
    def append_manage_data_op(
        ...
        """Append a :class:`ManageData <kuknos_sdk.operation.ManageData>`
        operation to the list of operations.
    ...
    def append_bump_sequence_op(
        ...
        """Append a :class:`BumpSequence <kuknos_sdk.operation.BumpSequence>`
        operation to the list of operations.
    ...
    def append_create_claimable_balance_op(
        ...
        """Append a :class:`CreateClaimableBalance <kuknos_sdk.operation.CreateClaimableBalance>`
        operation to the list of operations.
    ...
    def append_claim_claimable_balance_op(
        ...
        """Append a :class:`ClaimClaimableBalance <kuknos_sdk.operation.ClaimClaimableBalance>`
        operation to the list of operations.
    ...
    def append_begin_sponsoring_future_reserves_op(
        ...
        """Append a :class:`BeginSponsoringFutureReserves <kuknos_sdk.operation.BeginSponsoringFutureReserves>`
        operation to the list of operations.
    ...
    def append_end_sponsoring_future_reserves_op(
        ...
        """Append a :class:`EndSponsoringFutureReserves <kuknos_sdk.operation.EndSponsoringFutureReserves>`
        operation to the list of operations.
    ...
    def append_revoke_account_sponsorship_op(
        ...
        """Append a :class:`EndSponsoringFutureReserves <kuknos_sdk.operation.EndSponsoringFutureReserves>` operation
    ...
    def append_clawback_op(
        ...
        """Append an :class:`Clawback <kuknos_sdk.operation.Clawback>`
        operation to the list of operations.
    ...
    def append_clawback_claimable_balance_op(self, balance_id: str, source: str = None):
        """Append an :class:`ClawbackClaimableBalance <kuknos_sdk.operation.ClawbackClaimableBalance>`
        operation to the list of operations.
    ...
    def append_set_trust_line_flags_op(
        ...
        """Append an :class:`SetTrustLineFlags <kuknos_sdk.operation.SetTrustLineFlags>`
        operation to the list of operations.
